...
Mailjet.configure do |config|
  config.api_key = Rails.application.credentials.dig(:action_mailer, :apikey_public)
  config.secret_key = Rails.application.credentials.dig(:action_mailer, :apikey_private)
